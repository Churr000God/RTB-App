...
// GET - listado de devoluciones (039), paginado. Nace únicamente por
// ventas_cotizacion_cancelar() cuando el pedido ya mostraba entrega — sin
// POST aquí, no hay alta manual.
export async function GET(request: Request) {
  try {
    const { response } = await requireApiRole(ACCESO_PANTALLA.devoluciones);
